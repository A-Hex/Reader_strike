...
object AppStrings {
    ...
    private val englishStrings = mapOf(
        ...
        "onboarding_welcome_title" to "Read Consistently. Remember More.",
        "onboarding_welcome_subtitle" to "A calm reading coach for building a daily habit, saving meaningful ideas, and turning books into lasting knowledge.",
        ...
        "onboarding_features_title" to "Turn Reading Into Knowledge",
        "onboarding_features_subtitle" to "Save the ideas that matter, reflect for one minute after a session, and revisit what you learned later.",
    ...
    private val arabicStrings = mapOf(
        ...
        "onboarding_welcome_title" to "اقرأ باستمرار وتذكّر أكثر",
        "onboarding_welcome_subtitle" to "مدرب قراءة هادئ يساعدك على بناء عادة يومية، وحفظ الأفكار المهمة، وتحويل الكتب إلى معرفة باقية.",
        ...
        "onboarding_features_title" to "حوّل القراءة إلى معرفة",
        "onboarding_features_subtitle" to "احفظ الأفكار المهمة، وتأمل لدقيقة بعد كل جلسة، وراجع ما تعلمته لاحقاً.",
    ...
    private val frenchStrings = mapOf(
        ...
        "onboarding_welcome_title" to "Lisez régulièrement. Retenez davantage.",
        "onboarding_welcome_subtitle" to "Un coach de lecture calme pour créer une habitude quotidienne, sauvegarder les idées importantes et transformer les livres en connaissances durables.",
        ...
        "onboarding_features_title" to "Transformez la lecture en savoir",
        "onboarding_features_subtitle" to "Gardez les idées importantes, réfléchissez une minute après chaque session et révisez ce que vous avez appris.",
